...
const FIELDS = [
  ...
  },
  {
    ...
    label: "POS Locations",
    type: "multiselect",
    options: ["Outlet 1", "Outlet 2", "Outlet 3"],
    fullWidth: true,
  },
];
...
export default function AddEmployeeForm({
  ...
  return (
    <div className="w-full max-w-[840px] rounded-2xl bg-white">
      <h3 className="text-[22px] font-bold text-[#2E2E2E]">
                ...
                {f.type === "select" ? (
                  <div className="relative">
                    <Field
                      as="select"
                      name={f.name}
                      className="w-full rounded-lg border border-[#E5E7EB] px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#1D50AB]/30 bg-white appearance-none"
                    >
                  ...
                  <Field
                    ...
                    type={f.type}
                    placeholder={f.placeholder}
                    className="w-full rounded-lg border border-[#E5E7EB] px-4 py-3 placeholder:text-[#9CA3AF] text-sm outline-none focus:ring-2 focus:ring-[#1D50AB]/30"
                  />
                )}
